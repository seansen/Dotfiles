...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,            -1,  XK_w,      spawn,          SHCMD("~/.dotfiles/suckless_apps/suckless_scripts/dwm_setbg ~/.local/share/wallpapers") },
    ...
    { MODKEY,                    XK_d,  XK_w,      spawn,          SHCMD("~/.dotfiles/.config/suckless_apps/suckless_scripts/dmenu_emoji") },
    { MODKEY|ShiftMask,          XK_d,  XK_b,      spawn,          SHCMD("~/.dotfiles/suckless_apps/suckless_scripts/dmenu_browser") },
    { MODKEY,                    XK_d,  XK_c,      spawn,          SHCMD("~/.dotfiles/suckless_apps/suckless_scripts/dmenu_open_config") },
