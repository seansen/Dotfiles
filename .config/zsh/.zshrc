...
### EMACS TERM => There are some escape code you don't want, let's make it behave more considerately.
...
alias lo='exa -al --color=always --group-directories-first' # my preferred listing
