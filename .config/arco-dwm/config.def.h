...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,            -1,  XK_t,      spawn,          SHCMD("cool-retro-term") },
    { MODKEY,                      -1,  XK_b,      spawn,          {.v = firefoxcmd } },
    { MODKEY|ShiftMask,            -1,  XK_w,      spawn,          SHCMD("~/.dotfiles/.loacl/suckless-scripts/dwm_setbg ~/.dotfiles/.local/wallpapers") },
    { MODKEY|ShiftMask,            -1,  XK_i,      spawn,          SHCMD("sxiv -t  ~/.dotfiles/.local/wallpapers") },
    /* Nautilus */
    { MODKEY,                      -1,  XK_f,      spawn,          SHCMD("thunar") },
    /* Dmenu */
    { MODKEY,                    XK_d,  XK_d,      spawn,          {.v = dmenucmd } },
    { MODKEY,                    XK_d,  XK_w,      spawn,          SHCMD("~/.dotfiles/.local/suckless-scripts/dmenu_emoji") },
    { MODKEY|ShiftMask,          XK_d,  XK_b,      spawn,          SHCMD("~/.dotfiles/.local/suckless-scripts/dmenu_browser") },
    { MODKEY,                    XK_d,  XK_c,      spawn,          SHCMD("~/.dotfiles/.local/suckless-scripts/dmenu_open_config") },
    ...
    { MODKEY|ShiftMask,            -1,  XK_Up,     movestack,      {.i = +1 } },
    { MODKEY|ShiftMask,            -1,  XK_Down,   movestack,      {.i = -1 } },
